					...
					<ul>
						<li>
							<a href="#">
								...
								<div class="desc">
									<span><a href="gallery.php"> </a></span>
								</div>
							</a>
						</li>
						<li>
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center animate-box ">
						<div class="heading-section">
							...
							<p>Banco de imagens gratuito para pesquisa e trabalhos, aproveite.</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6 text-center animate-box">
						<div class="services">
							...
							<p>Baixe suas imagens como bem desejar.</p>
						</div>
					</div>
					<div class="col-md-6 text-center animate-box">
						<div class="services">
							<span><i class="icon-camera2"></i></span>
							<h3>Capture suas Imagens</h3>
							<p>Realize o <a href="upload_padrao.php">upload</a> de suas fotos no nosso site.</p>
						</div>
					</div>
				</div>
			</div>
