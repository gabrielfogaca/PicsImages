			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						<h2 class="intro-heading">Animais</h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-4 animate-box">
						<a href="images/Animais/an1.jpg" class="grid-photo img-popup" style="background-image: url(images/Animais/an1.jpg);">
							<div class="desc">		
							</div>
						</a>
					</div>
					<div class="col-md-4 animate-box">
						<a href="images/Animais/an2.jpg" class="grid-photo img-popup" style="background-image: url(images/Animais/an2.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-4 animate-box">
						<a href="images/Animais/an3.jpg" class="grid-photo img-popup" style="background-image: url(images/Animais/an3.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-3 animate-box">
						<a href="images/Animais/an4.jpg" class="grid-photo img-popup" style="background-image: url(images/Animais/an4.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-6 animate-box">
						<a href="images/Animais/an5.jpg" class="grid-photo img-popup" style="background-image: url(images/Animais/an5.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-3 animate-box">
						<a href="images/Animais/an6.jpg" class="grid-photo img-popup" style="background-image: url(images/Animais/an6.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
								...
								<div class="cold-md-12 text-center">
									<form method='post' action='upload.php' enctype='multipart/form-data'>
										<fieldset>
											...
											<input type="hidden" id="animais" name="animais" value="3">
