			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						<h2 class="intro-heading">Carros</h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-4 animate-box">
						<a href="images/Carros/car1.jpg" class="grid-photo img-popup" style="background-image: url(images/Carros/car1.jpg);">
							<div class="desc">		
							</div>
						</a>
					</div>
					<div class="col-md-4 animate-box">
						<a href="images/Carros/car2.jpg" class="grid-photo img-popup" style="background-image: url(images/Carros/car2.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-4 animate-box">
						<a href="images/Carros/car3.jpg" class="grid-photo img-popup" style="background-image: url(images/Carros/car3.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-6 animate-box">
						<a href="images/Carros/car4.jpg" class="grid-photo img-popup" style="background-image: url(images/Carros/car4.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-3 animate-box">
						<a href="images/Carros/car5.jpg" class="grid-photo img-popup" style="background-image: url(images/Carros/car5.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-3 animate-box">
						<a href="images/Carros/car6.jpg" class="grid-photo img-popup" style="background-image: url(images/Carros/car6.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
								...
								<div class="cold-md-12 text-center">
									<form method='post' action='upload.php' enctype='multipart/form-data'>
										<fieldset>
											...
											<input type="hidden" id="carros" name="carros" value="9">
