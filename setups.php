			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						<h2 class="intro-heading">Setups</h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-4 animate-box">
						<a href="images/Setups/st1.jpg" class="grid-photo img-popup" style="background-image: url(images/Setups/st1.jpg);">
							<div class="desc">		
							</div>
						</a>
					</div>
					<div class="col-md-4 animate-box">
						<a href="images/Setups/st2.jpg" class="grid-photo img-popup" style="background-image: url(images/Setups/st2.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-4 animate-box">
						<a href="images/Setups/st3.jpg" class="grid-photo img-popup" style="background-image: url(images/Setups/st3.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-4 animate-box">
						<a href="images/Setups/st4.jpg" class="grid-photo img-popup" style="background-image: url(images/Setups/st4.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-4 animate-box">
						<a href="images/Setups/st5.jpg" class="grid-photo img-popup" style="background-image: url(images/Setups/st5.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
					<div class="col-md-4 animate-box">
						<a href="images/Setups/st6.jpg" class="grid-photo img-popup" style="background-image: url(images/Setups/st6.jpg);">
							<div class="desc">
							</div>
						</a>
					</div>
								...
								<div class="cold-md-12 text-center">
									<form method='post' action='upload.php' enctype='multipart/form-data'>
										<fieldset>
											...
											<input type="hidden" id="setups" name="setups" value="6">
